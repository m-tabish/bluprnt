...
/*
* THIS IS OLD LANDING PAGE FROM BUILD FLOW
* USED WITHOUT LOGGING
* DO NOT MAKE IT AS LANDING PAGE
* */
    ...
    return (
        ...
        <div
            className={`h-screen  bg-cover bg-fixed  bg-center m-auto bg-black/10 text-white overflow-none  shadow-none  bg-no-repeat  overflow-x-hidden items-center flex flex-col`}>
            <Analytics/>


            <div className=" fixed -z-20 inset-0 bg-cover bg-center "
                 style={{backgroundImage: `url(${bg})`, backgroundBlendMode: 'hard-light', opacity: "90%"}}>
                <Socials className={'absolute top-1/3 bg-white rounded-sm'}/>
            </div>

            <div
                className='h-screen mt-24  flex flex-col  min-w-screen justify-center items-center overflow-visible overscroll-contain'>
                <div className="flex flex-col gap-3 scroll-my-0">

                    <div
                        className='text-center flex flex-col  text-black   tracking-wider mb-10 flex-wrap  items-center'>
                        <div
                            className="hover:underline  text-transparent h-24 mx-auto bg-center  font-extrabold  justify-end w-3/4 flex items-center gap-10 z-10 text-3xl"
                        ...
                        <div className="text-2xl font-semibold  text-white">Generate a Roadmap for your next project.
                        </div>
                        <div className="text-base font-semibold  text-white/60">Scroll down to see latest
                            roadmaps <ArrowDown size={"1em"} className=" inline animate-bounce"/>
                        </div>
                    </div>
                  ...
                  focus:outline-none active:outline-none active:ring-0 focus:ring-0'
                        ...
                        <span className="flex flex-col gap-2 ">
                            ...
                            {status === "failed" ? (
                                <div className="text-red-600 font-semibold w-full text-sm text-center"> Error Generating
                                    content. Please refresh the page and try again.</div>) : generation === "success" ?
                                (<div className="text-teal-300  font-semibold w-full text-sm text-center"> Successfully
                                    Generated your roadmap. Scroll to find it.</div>) : (
                                    <div className="text-white font-semibold w-full text-sm text-center">Click to
                                        Generate</div>)}
            ...
            <div className="  w-full text-center text-4xl mt-[10%] font-mono text-white/80">Check out what people have
                made <ArrowDown className="hover:translate-y-3 inline animate-bounce"/></div>
